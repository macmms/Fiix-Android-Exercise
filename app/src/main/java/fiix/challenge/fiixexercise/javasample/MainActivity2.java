...
public class MainActivity2 extends AppCompatActivity {
    ...
    /**
     * Update the list item flag to indicate that the answer for this question has been viewed.
     * @param position the position of the item that was viewed.
     */
    private void updateViewedFlag(int position){
        mTriviaQuestions.get(position).setViewed();
    }
}
