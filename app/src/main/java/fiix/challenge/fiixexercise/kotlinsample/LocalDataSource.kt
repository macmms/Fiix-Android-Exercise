...
class LocalDataSource : DataSource<List<TriviaQuestion>> {
    override fun getData(): List<TriviaQuestion> {
        return listOf(
            TriviaQuestion("How many books are in the Chronicles of Narnia series?", "7"),
            TriviaQuestion("Green Eggs and Ham is a book by which author?", "Dr. Seuss"),
            TriviaQuestion(
                "What is the title of the first Sherlock Holmes book by Arthur Conan Doyle?",
                "A Study in Scarlet"
            ),
            TriviaQuestion("Typically, how many keys are on a piano?", "88"),
            TriviaQuestion("In what year was the first Transformers movie released?", "1986"),
            TriviaQuestion(
            ...
            TriviaQuestion(
                "Where does the original Friday The 13th movie take place?",
                "Camp Crystal Lake"
            ),
            TriviaQuestion(
            ...
            TriviaQuestion("How many points is the Z tile worth in Scrabble?", "10"),
            TriviaQuestion(
